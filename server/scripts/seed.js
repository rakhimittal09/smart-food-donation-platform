  ...
  try {
      ...
      pickupDetails: {
        ...
        timeline: [
          ...
          },
          {
            ...
            description: 'Donor approved pickup for today afternoon.',
      ...
      pickupDetails: {
        ...
        timeline: [
          ...
          },
          {
            status: 'Approved',
            title: 'Request Approved',
            description: 'Donor approved immediate handover',
            timestamp: new Date(Date.now() - 20 * 60 * 60 * 1000),
            updatedBy: donor1._id,
          },
          {
            status: 'Completed',
            title: 'Handover & Distribution Completed',
            description: '50 meal packs handed over to NGO volunteers',
    ...
    await Notification.insertMany([
      ...
      },
      {
        ...
        message: 'Your request for Fresh Organic Apples & Bananas Crates was approved by Sharma Gourmet Catering.',
        type: 'success',
        isRead: false,
    ...
    await ActivityLog.insertMany([
      ...
      },
      {
        ...
        description: 'Approved request for "Fresh Organic Apples & Bananas Crates"',
        module: 'REQUEST',
      },
      {
        user: adminUser._id,
